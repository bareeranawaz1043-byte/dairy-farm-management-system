...
export default function Dashboard() {
  ...
  <div className="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
    ...
    {/* Total Cows */}
    <div className="bg-blue-500 text-white p-6 rounded shadow flex items-center justify-between">
      <div>
        <h2>Total Cows</h2>
        <p className="text-2xl font-bold">{data.cows}</p>
      </div>
      <FaCrow size={30} />   {/* cow ke liye closest icon */}
    </div>

    {/* Total Milk */}
    <div className="bg-green-500 text-white p-6 rounded shadow flex items-center justify-between">
      <div>
        <h2>Total Milk</h2>
    ...
    {/* Total Sales */}
    <div className="bg-purple-500 text-white p-6 rounded shadow flex items-center justify-between">
      <div>
        <h2>Total Sales</h2>
    ...
    {/* Alerts */}
    <div className="bg-red-500 text-white p-6 rounded shadow flex items-center justify-between">
      <div>
        <h2>Alerts</h2>
